...
project = st.text_input("Project code", help=st_help.project_help)
username = st.text_input("Jira Username", help=st_help.username_help)
api_key = st.text_input("Jira API Key", type="password", help=st_help.api_key_help)
jira_url = st.text_input("Jira URL", help=st_help.jira_url_help)
...
if project and username and api_key and jira_url:
